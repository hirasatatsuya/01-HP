...
?>
  <main id="page-01">
    ...
    <section id="page_mv">
      <h2 class="title">team01</h2>
      <h2 class="title_ja">01会</h2>
    </section>
    ...
    <section id="thought">
      <div class="background-img slideUpTrigger">
        <!-- <div class="arrow"> -->
          <!-- <h2>01会の思い</h2> -->
        <!-- </div>  -->
        <div class="wrapper">
  ...
  <section id="member">
    <h2 class="heading10 slideLeftTrigger" data-en="Member"><span>01会のメンバー</span></h2>
