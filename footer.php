      ...
      <nav class="footer_nav">
        <div class="col">
          ...
          <li><a href="<?php echo esc_url(home_url('/philosophy/#vmv')) ?>">Vision・Mission・Value</a></li>
            <li><a href="<?php echo esc_url(home_url('/philosophy/#concept')) ?>">01会の思い</a></li>
            <li><a href="<?php echo esc_url(home_url('/philosophy/#origin')) ?>">01の由来</a></li>
          </ul>
        ...
        <div class="col">
          ...
          <ul>
            <li><a href="<?php echo esc_url(home_url('/team01/concept/')) ?>">01の思い</a></li>
            <li><a href="<?php echo esc_url(home_url('/team01/events/')) ?>">イベント実績</a></li>
            <li><a href="<?php echo esc_url(home_url('/team01/members/')) ?>">メンバー実績</a></li>
            <li><a href="<?php echo esc_url(home_url('/team01/team01contact/')) ?>">01会のお問合せ</a></li>
          </ul>
        </div>
      </nav>
    </div>
